...
const PineIcon = ({ className, style }) => {
  return (
    <svg
      className={className}
      style={style}
    ...
    >
      ...
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(180deg) scaleY(1.01719) rotate(-180deg)",
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(150deg) scaleY(1.17386) rotate(-150deg)",
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(120deg) scaleY(1.16552) rotate(-120deg)",
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(90deg) scaleY(1.16781) rotate(-90deg)",
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(60deg) scaleY(1.05614) rotate(-60deg)",
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(30deg) scaleY(1.01948) rotate(-30deg)",
        }}
      ></path>
      <path
        ...
        style={{
          transformOrigin: "50px 50px",
          transform: "rotate(0deg) scaleY(0.997) rotate(0deg)",
        }}
      ></path>
    </svg>
  );
